...
const environment = {
  ...
  values: [
    ...
    { key: "functionsBase", value: "https://europe-west1-carfollow-75750.cloudfunctions.net", type: "default", enabled: true },
    { key: "firestoreBase", value: "https://firestore.googleapis.com/v1/projects/carfollow-75750/databases/carfollow-eu/documents/artifacts/cruiser-app-prod/public/data", type: "default", enabled: true },
    { key: "storageBucket", value: "carfollow-75750-media-eu", type: "default", enabled: true },
  ],
