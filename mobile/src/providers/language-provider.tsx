...
const translations = {
  tr: {
    ...
    'auth.showPassword': 'Şifremi göster',
    'auth.hidePassword': 'Şifremi gizle',
    'auth.resetEmailRequired': 'Şifre yenileme bağlantısı için e-posta adresinizi girin.',
    'auth.resetSent': 'Şifre yenileme bağlantısı e-posta adresinize gönderildi.',
    'auth.resetError': 'Şifre yenileme bağlantısı gönderilemedi. E-posta adresinizi kontrol edin.',
    ...
    'settings.help': 'Yardım ve Rehber',
    'settings.helpDescription': 'Özellik açıklamaları, kısa ekran turları ve yeni eklenenler.',
    'settings.helpValue': '7 özellik rehberi',
  ...
  en: {
    ...
    'auth.resetEmailRequired': 'Enter your email address to receive a password reset link.',
    'auth.resetSent': 'A password reset link has been sent to your email address.',
    'auth.resetError': 'The password reset link could not be sent. Check your email address.',
    ...
    'settings.help': 'Help & Guide',
    'settings.helpDescription': 'Feature explanations, quick screen tours and recent additions.',
    'settings.helpValue': '7 feature guides',
